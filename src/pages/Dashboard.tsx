        ...
        {!isMobile && (
          <div className="absolute top-4 right-8 z-10">
            <div className="relative group">
              ...
              <div className="absolute -bottom-12 right-0 bg-white py-1 px-2 rounded shadow-lg text-xs text-gray-600 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
